function dyn_latex_table_modified(options_,second_header, title, LaTeXtitle, headers, labels, values, label_width, val_width, val_precis, optional_header)
%function dyn_latex_table_modified(options_, title, LaTeXtitle, headers, labels, values, label_width, val_width, val_precis, optional_header,second_header)
...
value_format = sprintf('%%%d.%df', val_width, 2);
...
fprintf(fidTeX, ['\\caption{',title, '\\\\ $', second_header,'$}\\\\\n ']);
